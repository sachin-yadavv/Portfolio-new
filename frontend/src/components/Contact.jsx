...
export default function Contact() {
    ...
    return (
        <div id="contact" className="w-full px-[12%] py-10 scroll-mt-20 bg-[url('./assets/footer-bg-color.png')] bg-no-repeat bg-[length:90%_auto] bg-center dark:bg-none">
            ...
            <p className="text-center max-w-2xl mx-auto mt-5 mb-12 font-Ovo"> Feel free to reach out for collaborations, projects, internships,
  or just a friendly tech conversation.</p>
