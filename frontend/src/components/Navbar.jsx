  ...
  return (
    <>
      ...
      >
        <a
          href="#"
          className="text-3xl sm:text-4xl font-bold font-Ovo cursor-pointer mr-14 tracking-wide"
        >
          SY<span className="text-orange-500">.</span>
        </a>
        ...
        >
          ...
          <li>
            <a href="#CodingProfiles" onClick={closeMenu}>
              CodingProfiles
            </a>
          </li>
          <li>
